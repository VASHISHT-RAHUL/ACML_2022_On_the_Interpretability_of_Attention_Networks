# -*- coding: utf-8 -*-
"""last_layer_averaging_entropy_D1ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1T8jF-6NAtMtDKR1O9puUx1hH6Vh9qKMm
"""
...
def calculate_attn_loss(dataloader,what,where,criter,k):
  ...
  return r_loss/(i+1),cc_loss/(i+1),cc_entropy/(i+1),analysis
...
# FTPT_analysis.to_csv(path+"synthetic_zeroth.csv",index=False) # to save analysis data
