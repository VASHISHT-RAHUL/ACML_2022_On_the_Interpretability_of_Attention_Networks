# -*- coding: utf-8 -*-
"""second_layer_spherical_softmax_run1.ipynb
...
path = '/content/drive/MyDrive/Research/Research/AAAI/synthetic_dataset/spherical_softmax/second/' # change to save directory
