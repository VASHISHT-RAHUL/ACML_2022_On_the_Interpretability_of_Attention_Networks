# -*- coding: utf-8 -*-
"""second_layer_sparsemax_run1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1OUKLhvDJxBOpvhZTSVSF2R6V1tW0QJXa
"""

from google.colab import drive
drive.mount('/content/drive')

# https://github.com/anonymous-author-cse/AAAI_Interpretability_of_Attention_Models/blob/main/Effects_of_Softmax_alternative_and_Entropy_regularizer/Synthetic_Dataset/zeroth_layer_sparsemax.py

path = '/content/drive/MyDrive/Research/Research/AAAI/synthetic_dataset/sparsemax/second/' # change to save directory
...
# torch.save(where.state_dict(), path+'run_'+str(n)+'_focus.pt')
# torch.save(what.state_dict(), path+'run_'+str(n)+'_classify.pt')
